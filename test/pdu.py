...
class VarBindTest(unittest.TestCase):
    ...
    def helpAssertEnhancedParseError(self, hex_string, **kwargs):
    ...
    def test_decode_raises_ParseError_on_missing_fields(self):
        self.helpAssertEnhancedParseError("30 00", start=2)
        self.helpAssertEnhancedParseError("30 03 06 01 00", start=5)

    def test_decode_raises_ParseError_on_extra_fields(self):
        self.helpAssertEnhancedParseError("30 07 06 01 00 04 00 04 00", start=7)

    def test_decode_raises_ParseError_if_name_is_not_an_OID(self):
        self.helpAssertEnhancedParseError("30 03 02 01 00", start=2)

    def test_decode_raises_ParseError_on_unknown_tag(self):
        self.helpAssertEnhancedParseError("30 06 06 01 00 01 01 00", start=5)
